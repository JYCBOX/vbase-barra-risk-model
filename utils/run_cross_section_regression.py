...
factor_returns, residuals = calculate_factor_returns(
...
residuals.to_csv("../vbase-data/regression_residuals.csv", float_format="%.10f")
print(f"[DONE] save regression_residuals.csv  shape={residuals.shape}")
