...
"""Unit tests for factor returns calculation."""
...
class TestCalculateFactorReturns(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        idx = pd.MultiIndex.from_product([cls.periods, cls.assets], names=("period", "asset"))
    ...
    """Test the calculation of factor returns from asset returns, exposures, and weights."""

    def test_basic_factor_returns(self):
        fr = calculate_factor_returns(self.returns_df, self.exposures_df, self.weights_df)
    ...
    """Test that the function raises ValueError for mismatched indices."""
...
"""Test that the function raises ValueError for empty DataFrames."""
